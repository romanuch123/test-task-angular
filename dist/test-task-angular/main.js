...
module.exports = "<div class=\"dashboard-menu__wrapper\" appClickOutside (clickOutside)=\"hideMenu()\">\n  <div class=\"dashboard-menu__wrapper__logo\">\n    <span>LOGO</span>\n  </div>\n  <hr>\n\n</div>\n<nav>\n  <ul class=\"dashboard-menu__list\">\n    <li *ngFor=\"let menuItem of menuList\" (click)=\"hideMenu()\" class=\"dashboard-menu__list__item\">\n      <a\n        routerLink=\"/{{menuItem.path}}\"\n        routerLinkActive=\"active\"\n        [routerLinkActiveOptions]=\"{exact:true}\"\n      >\n        <span><i [ngClass]=\"menuItem.icon\"></i></span>{{ menuItem.name }}\n      </a>\n    </li>\n  </ul>\n</nav>"
...
module.exports = ".dashboard-menu__list {\n  list-style-type: none; }\n  .dashboard-menu__list__item a {\n    padding: 10px;\n    text-decoration: none;\n    color: #000;\n    display: block;\n    box-sizing: border-box; }\n  .dashboard-menu__list__item a:hover {\n      background: #ececec; }\n  .dashboard-menu__list__item a.active {\n      background: lightgray; }\n  .dashboard-menu__wrapper__logo {\n  display: none; }\n  .dashboard-menu__wrapper hr {\n  margin: 0;\n  border: none;\n  border-top: 1px solid green; }\n  @media screen and (max-width: 900px) {\n  .dashboard-menu__wrapper__logo {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    min-height: 63px; }\n    .dashboard-menu__wrapper__logo span {\n      padding: 20px; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DashboardMenuComponent = /** @class */ (function () {
    function DashboardMenuComponent(router) {
        this.router = router;
        this.onHideMenu = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    DashboardMenuComponent.prototype.hideMenu = function () {
        if (this.isMenuOpen) {
    ...
    ], DashboardMenuComponent.prototype, "onHideMenu", void 0);
...
module.exports = ".dashboard-header {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  z-index: 100;\n  box-sizing: border-box;\n  min-height: 64px;\n  background: #244632;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 20px; }\n  .dashboard-header__logo {\n    color: #fff; }\n  .dashboard-header__logo a {\n      color: #fff;\n      text-decoration: none; }\n  .dashboard-header__logo a:hover {\n        color: #e6e5e5; }\n  .dashboard-header__user-info {\n    color: #fff; }\n  .dashboard-header__user-info a {\n      color: #fff;\n      text-decoration: none; }\n  .dashboard-header__user-info .sign-control {\n      border: 1px solid #fff;\n      border-radius: 7px;\n      padding: 5px 20px;\n      margin-left: 10px; }\n  .dashboard-header__user-info .sign-control:hover {\n        cursor: pointer; }\n  .dashboard-header__menu-btn {\n    display: none;\n    color: #ffffff;\n    background: transparent; }\n  .dashboard__menu {\n  position: fixed;\n  top: 64px;\n  left: 0;\n  width: 200px;\n  background: #f9f9f9;\n  min-height: 100vh;\n  transition: left .3s linear; }\n  .dashboard__content {\n  padding: 64px 0 0 200px; }\n  .menu-open-shadow {\n  display: none; }\n  @media screen and (max-width: 900px) {\n  .dashboard-header__menu-btn {\n    display: block; }\n  .dashboard__menu {\n    z-index: 102;\n    top: 0px;\n    left: -200px;\n    width: 200px;\n    background: #f9f9f9;\n    min-height: 100vh; }\n  .dashboard__content {\n    padding: 64px 0 0 0; }\n  .dashboard.menu-open .dashboard__menu {\n    left: 0; }\n  .menu-open-shadow {\n    display: block;\n    position: fixed;\n    z-index: 101;\n    top: 0;\n    left: 0;\n    height: 100vh;\n    width: 100vw;\n    background: #000000;\n    opacity: 0.7; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "label {\n  display: block;\n  padding: 5px 0; }\n\n.login-form {\n  display: flex;\n  flex-direction: column;\n  align-items: center; }\n\n.login-form .form-row {\n    width: 50%;\n    margin: 10px;\n    position: relative; }\n\n.login-form .form-row .validate-msg {\n      color: red;\n      position: absolute;\n      top: 100%;\n      left: 0;\n      display: none; }\n\n.login-form .form-row .login-btn {\n      margin: 0 auto;\n      display: block;\n      background: #244632;\n      color: #fff;\n      width: 150px;\n      padding: 10px 0;\n      border-radius: 7px; }\n\n.login-form .form-row .login-btn:hover {\n        background: #13241a; }\n\n.login-form .form-row a {\n      text-decoration: underline; }\n\n.login-form .form-row a:hover {\n        cursor: pointer; }\n\n.exist-user-msg {\n  color: red; }\n\n@media screen and (max-width: 900px) {\n  .login-form .form-row {\n    width: 90%; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".task-item {\n  display: flex;\n  justify-content: space-between;\n  position: relative;\n  align-items: center;\n  padding: 10px 20px;\n  margin: 15px 20px;\n  border: 1px solid grey;\n  border-radius: 7px;\n  background: #f5f5f5; }\n  .task-item__info {\n    display: flex;\n    align-items: center; }\n  .task-item__info input {\n      margin-right: 10px; }\n  .task-item__controls {\n    display: flex; }\n  .task-item__controls button {\n      background: transparent; }\n  .task-item__shared-box {\n    position: absolute;\n    top: 110%;\n    right: 0;\n    z-index: 10;\n    width: 200px;\n    padding: 10px 20px;\n    border: 1px solid grey;\n    border-radius: 7px;\n    background: #f5f5f5;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); }\n  .task-item__shared-from {\n    position: absolute;\n    top: -11px;\n    background: white;\n    border: 1px solid silver;\n    border-radius: 7px;\n    padding: 1px 5px; }\n  .shared-box {\n  text-align: center; }\n  .shared-box__close-btn {\n    position: absolute;\n    right: 0;\n    top: 0;\n    background: transparent;\n    padding: 3px; }\n  .shared-box__content {\n    max-height: 150px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    overflow: auto; }\n  .shared-box__content button {\n      background: transparent;\n      margin: 5px 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
